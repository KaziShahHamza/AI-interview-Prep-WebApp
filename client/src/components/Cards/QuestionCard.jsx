...
const QuestionCard = (question, answer, isPinned, onLearnMore, onTogglePin) => {
  ...
  // console.log("Answer from QuestionCard: ", question.answer);
  // console.log("question from QuestionCard: ", question.question);
  // console.log("isPinned from QuestionCard: ", question.isPinned);
