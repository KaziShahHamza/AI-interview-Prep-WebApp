...
const AIResponsePreview = ({ content }) => {
  ...
  //   console.log("Answer from AIResponse: ", content);

  return (
    <div className="max-w-4xl mx-auto">
      <div className="text-[15px] prose prose-slate dark:prose-invert max-w-none">
        <ReactMarkDown
          ...
          components={{
            ...
            ol({ children }) {
              return (
                <ol className="list-discimal pl-6 space-y-2 my-4">
                  {children}
                </ol>
              );
            },
            ...
            img({ children }) {
              return <img className="my-4 max-w-full rounded">{children}</img>;
            },
          }}
        >
          {content}
    ...
    <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
      <div className="flex items-center justify-between px-4 py-2 bg-gray-100 border-b border-gray-200">
        ...
        >
          ...
          {copied && (
            <span className="absolute top-8 right-0 bg-gray-800 text-white text-xs rounded-md px-2 py-1 transition">
              Copied!   
            </span>
          )}
        </button>
